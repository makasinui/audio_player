<template>
    <AuthLayout page="Регистрация" :leftNavigation="false">
        <v-form @submit.prevent="handleSubmit" ref="form" class="register">
            ...
            <TextField
                ...
                type="password"
                :rules="[rules('min', 8), rules('same', password)]"
            />
        ...
        <v-snackbar :timeout="3000" color="red" v-model="error">{{ errorText }}</v-snackbar>
    </AuthLayout>
</template>
<script setup>
